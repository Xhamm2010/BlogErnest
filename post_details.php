...
//     $cat_id = $_GET["filter"];
//     $post = $post_controller->getPostsByCategory($cat_id);
// }
...
$categories = $post_controller->getAllCategories();
                ...
                <div class="row">
                    <div class="col-md-9 post-content" data-aos="fade-up">
                        ...
                        <div class="single-post">
                            <div class="post-meta"><span class="date"><?= $post[0]["cat_name"] ?></span> <span class="mx-1">&bullet;</span>
                                <?php
                                $created = date("d F y", strtotime($post[0]["created_at"]))
                                ?>
                                <span>
                                    <?= $created  ?>
                                </span>
                            </div>
                            <h1 class="mb-5"><?= $post[0]["post_title"] ?></h1>
                            <p><span class="firstcharacter"></span><?= $post[0]["post_content"] ?></p>

                            <figure class="my-4">
                                <img src="./post_images/post_<?= $post[0]["id"] ?>/<?= $post[0]["post_image"] ?>" alt="" class="img-fluid" width="900px" height="900px">
