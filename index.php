...
if (isset($_GET["filter"])) {
    $cat_id = $_GET["filter"];
    $posts = $post_controller->getPostsByCategory($cat_id);
}
                        ...
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                <div class="post-entry-1">
                                    <a href="post_details.php?post_id=<?= $post['id'] ?>"><img
                                            src="./post_images/post_<?= $post["id"] ?>/<?= $post["post_image"] ?>"
                                            alt="" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date"><?= $post["cat_name"] ?></span> <span
                                            class="mx-1">&bullet;</span><?= $post["created_at"] ?></span></div>
                                    <h2><a
                                            href="post_details.php?post_id=<?= $post['id'] ?>"><?= $post["post_title"] ?></a>
                                    </h2>
                                </div>
                                <?php
                                }
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                ?>
                                <div class="post-entry-1">
                                    <a href="post_details.php"><img
                                            src="./post_images/post_<?= $featured_post["id"] ?>/<?= $featured_post["post_image"] ?>"
                                            alt="" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date"><?= $featured_post["cat_name"] ?></span>
                                        <span class="mx-1">&bullet;</span>
                                        <span><?= $featured_post["created_at"] ?></span>
                                    </div>
                                    <h2><a href="single-post.html"><?= $featured_post["post_title"] ?></a></h2>
                                </div>
                                <?php
                                }
                                ?>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mt-3 text-center fw-bold">
                                    ...
                                    <ul>
                                        <li style="font-weight: 600; text-align: justify; list-style-type:none">
                                            <a href="?filter=<?= $category["cat_id"] ?>"
                                                class="btn btn-success"><?= $category["cat_name"] ?></a>
                                            <span><?= $category["num_of_posts"] ?></span>
                                        </li>
                                    </ul>
